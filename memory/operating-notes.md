...
- Use `gpt-5.5` as the default LLMGate model for heavy work and coding proposals; use `gpt-5.4` only as fallback, and `gpt-5.4-mini` only for quick low-stakes checks.
