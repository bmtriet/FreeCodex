...
REQUIRED_PATHS = [
    ...
    "templates/lead-record.md",
    "templates/outreach-draft.md",
    "templates/delivery-checklist.md",
    "templates/weekly-acquisition-summary.md",
    "templates/vibe-launch-safety-report.md",
    "docs/revenue-strategy.md",
    "docs/acquisition-plan.md",
    "docs/funnel-metrics.md",
    ...
    "docs/sales/vibe-launch-safety-sprint.md",
    "docs/sales/vibe-launch-safety-scope.md",
    "docs/sales/vibe-launch-safety-intake.md",
    "docs/sales/vibe-launch-safety-outreach.md",
    "docs/sales/vibe-launch-safety-followup.md",
    ...
    "site/index.html",
    "site/styles.css",
    "site/ai-app-launch-safety-checklist.html",
